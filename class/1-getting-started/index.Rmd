...
## `r fa('calendar-alt')` Midterm (weeks 1 - 7) on March 10

## `r fa('calendar-alt')` Final (weeks 1 - 13) on May 05
...
# `r fa('hdd')` [Course Software](https://p4a.seas.gwu.edu/2022-Spring/ref-course-software.html)

<br>

--

## `r fa('slack')` [Slack](https://emse-p4a-s22.slack.com/): Install app & **turn notifications on**!
...
## `r fa('hdd')` Install [course software](https://p4a.seas.gwu.edu/2022-Spring/ref-course-software.html) if you haven't
...
# `r fa('exclamation-circle')` [HW 1](https://p4a.seas.gwu.edu/2022-Spring/hw1-getting-started.html) - read carefully!

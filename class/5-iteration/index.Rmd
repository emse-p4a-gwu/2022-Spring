...
`sumOfOddsFromMToNMax(m, n, max)`: Write a function that sums every _odd_ integer from `m` to `n` up until the sum is less than or equal to the value `max`. Your solution should use both `break` and `next` statements.
...
# [HW 5](https://p4a.seas.gwu.edu/2022-Spring/hw5-iteration.html)

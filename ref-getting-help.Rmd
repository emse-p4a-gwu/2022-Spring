...
All course communication will be managed through [Slack](https://emse-p4a-s22.slack.com). A link to sign up for the course slack page can be found on the one (and only) announcement on Blackboard.
